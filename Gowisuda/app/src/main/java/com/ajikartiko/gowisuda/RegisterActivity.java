    ...
    public void startRegistration(View view) {
        ...
        if (!TextUtils.isEmpty(email) && !TextUtils.isEmpty(pass)) {
            ...
            mAuth.createUserWithEmailAndPassword(email, pass)
                    .addOnFailureListener(e -> Toast.makeText(RegisterActivity.this, "Register gagal " + e.getMessage(), Toast.LENGTH_SHORT).show())
        ...
        if (user != null) {
            user.sendEmailVerification()
                    .addOnSuccessListener(aVoid -> {
                        ...
                        firestoreUtil.createOrGetUserProfile(u -> {
                            Toast.makeText(RegisterActivity.this, "Berhasil, Email Verifikasi telah Dikirim Ke email ", Toast.LENGTH_SHORT).show();
