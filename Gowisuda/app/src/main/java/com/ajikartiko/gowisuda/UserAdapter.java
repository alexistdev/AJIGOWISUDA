...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.holder> {
    ...
    public void onBindViewHolder(@NonNull final UserAdapter.holder holder, int position) {
        ...
        if (users.getImage()!= null) {
            ...
            storageReference.child("user profile dosen").child(users.getImage()).child("Images").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
        ...
        reference = FirebaseDatabase.getInstance().getReference("Dosen").child(users.getImage()).child("profile");
        ...
        holder.v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("em_dos",users.getEmail());
