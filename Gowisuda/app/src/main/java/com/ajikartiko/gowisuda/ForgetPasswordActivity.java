    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resetPassword.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(userEmail)) {
                Toast.makeText(ForgetPasswordActivity.this, "masukan email", Toast.LENGTH_SHORT).show();
            } else {
                FirebaseAuth.getInstance().sendPasswordResetEmail(userEmail)
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(ForgetPasswordActivity.this, "Reset password terkirim ke email anda", Toast.LENGTH_SHORT).show();
        ...
        backLogin.setOnClickListener(v -> startActivity(new Intent(ForgetPasswordActivity.this, LoginActivity.class)));
    }
}