...
import com.ajikartiko.gowisuda.model.ChatChannel;
        ...
        reference.get().addOnSuccessListener(documentSnapshot -> {
            ...
            if (!documentSnapshot.exists()) {
                if (firebaseUser != null) {
                    user = new Mahasiswa(mAuth.getCurrentUser().getUid(), "", firebaseUser.getEmail(), (firebaseUser.getPhotoUrl() != null) ? firebaseUser.getPhotoUrl().toString() : "", UserType.MAHASISWA, "", 0, "");
