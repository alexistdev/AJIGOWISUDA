...
public class ProfileActivity extends AppCompatActivity {
    ...
    private CustomTextInputDialog editTextDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextDialog = new CustomTextInputDialog();
        ...
        if (currentUser != null) {
            ...
            Glide.with(this).load(currentUser.getImage()).into(profilePicImageView);
            if (currentUser instanceof Mahasiswa) {
                ...
                semsterTextView.setVisibility(View.GONE);
