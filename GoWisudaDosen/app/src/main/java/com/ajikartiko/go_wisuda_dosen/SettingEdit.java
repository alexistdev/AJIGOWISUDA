...
public class SettingEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileNameTextView = findViewById(R.id.profile_name_textView1);
        ...
        storageReference = firebaseStorage.getReference();
        storageReference.child("user profile dosen").child(firebaseAuth.getUid()).child("Images").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot dataSnapshot) {
                ...
                userInformasi userProfile = dataSnapshot.child(user.getUid()).child("profile").getValue(userInformasi.class);
    ...
    public void buttonClickedEditName(View view) {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                userInformasi userinformation = new userInformasi(name);
