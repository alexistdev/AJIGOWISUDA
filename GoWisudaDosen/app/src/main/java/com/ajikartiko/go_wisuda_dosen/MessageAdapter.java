...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public com.ajikartiko.go_wisuda_dosen.MessageAdapter. ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        if (viewType == MSG_TYPE_RIGHT){
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.chatitem_right, viewGroup, false);
            return new com.ajikartiko.go_wisuda_dosen.MessageAdapter.ViewHolder(view);
        }else{
