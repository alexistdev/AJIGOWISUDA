...
public class ResendEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.logout).setOnClickListener(v -> {
            ...
            startActivity(new Intent(this, com.ajikartiko.go_wisuda_dosen.LoginActivity.class));
        });
    ...
    private void sendVerificationEmail() {
        ...
        if (user != null) {
            user.sendEmailVerification()
                    .addOnSuccessListener(aVoid -> Toast.makeText(com.ajikartiko.go_wisuda_dosen.ResendEmailActivity.this, "Verifikasi Sudah Dikirim Ulang, Cek Email anda", Toast.LENGTH_SHORT).show())
                    .addOnFailureListener(e -> Toast.makeText(com.ajikartiko.go_wisuda_dosen.ResendEmailActivity.this, "Email Tidak Berhasil Dikirim, " + e.getMessage(), Toast.LENGTH_SHORT).show());
        }
    }
}